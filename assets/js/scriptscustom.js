!(function (h, u) {
  ...
  return (function (h) {
    function u(n) {
      ...
      return h[n].call(s.exports, s, s.exports, u), (s.loaded = !0), s.exports;
    }
    var r = {};
    return (u.m = h), (u.c = r), (u.p = "dist/"), u(0);
  })([
    function (h, u, r) {
      "use strict";
      function n(o) {
      ...
      var s =
        ...
        E = function () {
          ...
          if ((o && (F = !0), F))
            return (S = (0, G.default)(S, v)), (0, I.default)(S, v.once), S;
        },
        P = function () {
          (S = (0, B.default)()), E();
        };
      h.exports = {
        init: function (o) {
          (v = s(v, o)), (S = (0, B.default)());
          var x = document.all && !window.atob;
          return (function (o) {
            return (
              !0 === o ||
              ("mobile" === o && j.default.mobile()) ||
              ("phone" === o && j.default.phone()) ||
              ("tablet" === o && j.default.tablet()) ||
              ("function" == typeof o && !0 === o())
            );
          })(v.disable) || x
            ? void S.forEach(function (o, x) {
            ...
            : (v.disableMutationObserver ||
              ...
              window.addEventListener(
                "resize",
                (0, a.default)(E, v.debounceDelay, !0)
              ),
              window.addEventListener(
                "orientationchange",
                (0, a.default)(E, v.debounceDelay, !0)
          ...
          return (
            ...
            (function (t, d, o) {
              function x(l) {
                var O = z,
                  W = T;
                return (z = T = void 0), (H = l), (k = t.apply(W, O));
              }
              function A(l) {
                return (H = l), (g = setTimeout(C, d)), $ ? x(l) : k;
              }
              function Y(l) {
                var O = l - _;
              ...
              function R(l) {
                return (g = void 0), y && z ? x(l) : ((z = T = void 0), k);
              }
              function N() {
                var l = e(),
                  O = Y(l);
                if (((z = arguments), (T = this), (_ = l), O)) {
                  if (void 0 === g) return A(_);
                  if (L) return (g = setTimeout(C, d)), x(_);
                }
                return void 0 === g && (g = setTimeout(C, d)), k;
              }
              var z,
                T,
                q,
            ...
            })(t, d, { leading: x, maxWait: d, trailing: A })
          );
        };
      }.call(
        u,
      ...
      (function (r) {
        ...
        var p =
          ...
          G =
            ...
            r,
          J =
            "object" == ("undefined" == typeof self ? "undefined" : p(self)) &&
            self &&
            self.Object === Object &&
            self,
        ...
        h.exports = function (e, t, d) {
          function o(y) {
            var l = N,
              O = z;
            return (N = z = void 0), (_ = y), (q = e.apply(O, l));
          }
          function x(y) {
            return (_ = y), (k = setTimeout(Y, t)), H ? o(y) : q;
          }
          function D(y) {
            var l = y - g;
          ...
          function C(y) {
            return (k = void 0), L && N ? o(y) : ((N = z = void 0), q);
          }
          function Q() {
            var y = P(),
              l = D(y);
            if (((N = arguments), (z = this), (g = y), l)) {
              if (void 0 === k) return x(g);
              if ($) return (k = setTimeout(Y, t)), o(g);
            }
            return void 0 === k && (k = setTimeout(Y, t)), q;
          }
          var N,
            z,
            T,
    ...
    function (h, u) {
      ...
      function r(p) {
        ...
        for (a = 0; a < p.length; a += 1)
          if (
            ((f = p[a]).dataset && f.dataset.aos) ||
            (f.children && r(f.children))
          )
            return !0;
        return !1;
      }
    ...
    function (h, u) {
      ...
      var s = (function () {
          ...
          return function (c, m, j) {
            return m && f(c.prototype, m), j && f(c, j), c;
          };
        })(),
        b =
    ...
    function (h, u, r) {
      ...
      Object.defineProperty(u, "__esModule", { value: !0 });
      var i,
        b = (i = r(13)) && i.__esModule ? i : { default: i };
      u.default = function (i, p) {
        var a = 0,
          f = 0,
        ...
        switch (
          ...
          m.anchor &&
            ...
            (i = document.querySelectorAll(m.anchor)[0]),
          (a = (0, b.default)(i).top),
          m.anchorPlacement)
        ) {
          case "top-bottom":
        ...
        return m.anchorPlacement || m.offset || isNaN(p) || (f = p), a + f;
      };
    },
    function (h, u) {
      "use strict";
